...
class _RemoteExecutionCommandConnection(object):
    ...
    def _try_accept(self, broadcast_connection):
        '''
        Wait to accept a connection on the TCP based command connection. This makes 2 attempts to receive a connection, waiting for 5 seconds between each attempt (10 seconds total).
        ...
        for _n in range(2):
            ...
            try:
                ...
                self._command_channel_socket.settimeout(120)
                return
            except _socket.timeout:
                continue
